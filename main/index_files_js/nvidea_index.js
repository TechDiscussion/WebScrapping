...
const mainPageNvidea = "https://blogs.nvidia.com/"
const Nvidiablogs = [
	"https://blogs.nvidia.com/"
];
// for(let i =2; i<=11; i++){
// 	Nvidiablogs.push("https://yahooeng.tumblr.com/page/" + i + "/");
// }
...
(async () => {
	...
	for(let Nvidiablog of Nvidiablogs){
		for(let i=1; i<=12; i++){
			...
			let title = $("#post-48248 > header > div.header-text > h4 > a").text().trim();
	...
	fs.writeFileSync('../../json/json-data-js/nvidea.json', json, 'utf8');
