...
class Scrapy {
    ...
    constructor(path = ``, host = `https://medium.com/airbnb-engineering`) {
        this.path = path
        this.host = host
                            ...
                            for(let k=1; k<=3; k++){
                                if(document.querySelector("#container > div:nth-child(2) > div > div.u-marginBottom40.js-collectionStream > div:nth-child("+i+") > section > div:nth-child("+j+") > div:nth-child("+k+") > div.col.u-xs-marginBottom10.u-paddingLeft0.u-paddingRight0.u-paddingTop15.u-marginBottom30 > a > h3 > div") != null){
                                    titles.push({
                                        ...
                                        link: document.querySelector("#container > div:nth-child(2) > div > div.u-marginBottom40.js-collectionStream > div:nth-child("+i+") > section > div:nth-child("+j+") > div:nth-child("+k+") > div.u-lineHeightBase.postItem > a").href
                                    })
                                }
                            }
                        }
    ...
    buildJSON() {        
        fs.writeFileSync('../../../json/json-data-js/airbnb.json', JSON.stringify(this.items));
    }
}
